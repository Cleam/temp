;(function(win,$){
    ...
    sS.prototype.init = function(options){
        ...
        if(me._liLength <= 1) {
            fnStopSlide(me);
            me.$el.unbind('webkitTransitionEnd MSTransitionEnd transitionend touchstart touchmove touchend');
            return false;
        }
    ...
    function fnAutoSlide(me){
        if(me.opts.autoSwipe && me._liLength > 1){
            fnStopSlide(me);
    ...
    // 停止轮播
    sS.prototype.fnStopSlide = function(i){
        var me = this;
        clearInterval(me.autoSlide);
    };
